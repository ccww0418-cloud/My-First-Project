...
// ★ 이 검사를 완화했다가 되돌렸습니다 (2026-09-03).
//   프롬프트를 82% 잘라내면서 이 문구들이 사라졌고, 그때 "테스트가 요구사항이
//   아니라 표현을 지키고 있다" 고 판단해 정규식으로 느슨하게 바꿨습니다.
//   그런데 삭감 자체가 잘못이었습니다 — 근거로 든 모순 3건은 이미 고쳐져
//   있었고, 사고에서 얻은 지시들만 함께 사라져 추천 품질이 나빠졌습니다.
//   프롬프트를 되돌렸으므로 검사도 원래의 정확한 문구로 돌립니다.
//   사용자에게 보일 문장을 고정하는 것은 과잉 명세가 아니라, 전환 응답의
//   형식을 일정하게 유지하는 요구사항입니다.
